        ...
        Screen
{
    ...
    protected final AglyPhysics game;
    ...
    public void show()
    {
        Gdx.app.log( AglyPhysics.LOG, "Showing screen: " + getName() );
    ...
    public void resize(
        ...
        int height )
    {
        Gdx.app.log( AglyPhysics.LOG, "Resizing screen: " + getName() + " to: " + width + " x " + height );
    }
    ...
    public void hide()
    {
        Gdx.app.log( AglyPhysics.LOG, "Hiding screen: " + getName() );
    ...
    public void pause()
    {
        Gdx.app.log( AglyPhysics.LOG, "Pausing screen: " + getName() );
    }

    @Override
    public void resume()
    {
        Gdx.app.log( AglyPhysics.LOG, "Resuming screen: " + getName() );
    }

    @Override
    public void dispose()
    {
        Gdx.app.log( AglyPhysics.LOG, "Disposing screen: " + getName() );
